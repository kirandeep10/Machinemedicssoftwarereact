...
export default function Home() {
    var userData = JSON.parse(sessionStorage.getItem('data'))[0];
    return (
        <>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
                            <h1>Welcome to Machine Medics</h1>
                            <h2>We track the services of machines.</h2>
                            <div className="d-flex justify-content-center justify-content-lg-start">
                                <Link to="/view-machine" className="btn-get-started scrollto">View Machines</Link>
                                <Link to="" className="glightbox btn-watch-video"><i className="bi bi-gear"></i><span>Upcoming Services</span></Link>
                            </div>   
                        </div>   
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-6">
                                <div className="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="100">
                                    <div className="pic"><img src={userData?.idProof} className="img-fluid" alt=""/></div>
